...
- [x] Coordinator: document qualified scope, legacy behavior and remaining runtime limits; complete final review, fix actionable findings, and synchronize the scoped changes to the verified private remote under the existing authorization.
