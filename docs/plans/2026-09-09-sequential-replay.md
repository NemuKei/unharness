...
- [x] Reconcile paired READMEs, architecture/status/compatibility and recovery instructions, check links/diff, directly review and integrate. All 234 changed-document relative links and whitespace checks passed. `main` was fast-forwarded through the reviewed code and evidence (`2e200d6`), then rebuilt successfully. The active full Mac goal continues into AI/MCP, Claude Code and product finish.
