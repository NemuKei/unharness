...
- [x] Update accepted mode docs and evidence, check relative links and `git diff --check`, conduct the broad final review, then commit/push only the authorized private branch and verify remote SHA/clean state.
