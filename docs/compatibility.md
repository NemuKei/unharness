...
The [registered-loadout native smoke](evidence/2026-09-06-loadouts-macos.md) adds local filesystem/service evidence for immutable versions, source checkpoints and restoration on Mac. Its suite passes 121 tests. It does not add desktop favorite-associated task evidence or validate real personal sources; Windows still needs the same local-store and fixture checks natively.
