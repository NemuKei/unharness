export const USER_SOURCE_ERROR_KINDS = Object.freeze([
  ...
  'replaced-source-unavailable',
  'replaced-source-confirmation-required',
  'replaced-source-record-invalid',
  'stale-review',
  ...
  'mode-inheritance-invalid',
  'source-state-v3-invalid',
  'setup-skill-state-unavailable',
  'setup-plugin-control-unavailable',
  'plugin-origin-unverified',
  'plugin-inventory-unavailable',
  'plugin-dependency-changed',
  'plugin-enrollment-proposal-invalid',
  'plugin-enrollment-record-invalid',
  'plugin-enrollment-source-limit',
  'plugin-enrollment-unsupported',
  'setup-required-control',
  'setup-record-invalid',
  'setup-application-unsupported',
  'setup-required',
  'enrollment-proposal-invalid',
  'enrollment-record-invalid',
  'enrollment-source-limit',
