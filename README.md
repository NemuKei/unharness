...
A [Mac arm64 package candidate](docs/plugin-package.md) now includes Node, the UI, MCP and management/setup Skills. An isolated native Codex installation and in-app-browser initial save have been checked. Public distribution, update/removal recovery and the full onboarding journey remain unfinished.
