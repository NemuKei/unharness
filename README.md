...
The development build can now [open and reuse its local workbench](docs/local-workbench.md) through CLI or a registered MCP connection. This preserves saved settings and supplies a browser URL; the complete plugin installer and public-domain connection are still being built.
